...
#
macro(SWIG_ADD_SOURCE_TO_MODULE name outfiles extra_outfiles infile)
  ...
  set(${extra_outfiles} "${swig_extra_generated_files}")
endmacro()
...
macro(SWIG_ADD_LIBRARY name)
  ...
  set(swig_extra_generated_sources)
  set(swig_generated_targets)
  foreach(it ${swig_dot_i_sources})
    SWIG_ADD_SOURCE_TO_MODULE(${name} swig_generated_source swig_extra_generated_source ${it})
    set(swig_generated_sources ${swig_generated_sources} "${swig_generated_source}")
	set(swig_extra_generated_sources ${swig_extra_generated_sources} "${swig_extra_generated_source}")
  ...
  set_property(TARGET ${SWIG_MODULE_${name}_REAL_NAME} PROPERTY EXTRA_OUTPUT ${swig_extra_generated_sources})
endmacro()
